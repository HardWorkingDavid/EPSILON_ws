...
bool vehicle_msgs__msg__free_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vehicle_msgs.msg._free_state.FreeState", full_classname_dest, 38) == 0);
  }
  vehicle_msgs__msg__FreeState * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of FreeState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vehicle_msgs.msg._free_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FreeState");
