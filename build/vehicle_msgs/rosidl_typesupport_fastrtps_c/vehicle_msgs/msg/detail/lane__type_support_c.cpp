...
#include "vehicle_msgs/msg/detail/lane__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point__functions.h"  // final_point, points, start_point
#include "rosidl_runtime_c/primitives_sequence.h"  // child_id, father_id
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // child_id, father_id
...
using _Lane__ros_msg_type = vehicle_msgs__msg__Lane;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: child_id
  {
    size_t size = ros_message->child_id.size;
    auto array_ptr = ros_message->child_id.data;
  ...
  {
    size_t size = ros_message->father_id.size;
    auto array_ptr = ros_message->father_id.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serializeArray(array_ptr, size);
  }

  // Field name: l_lane_id
  {
    cdr << ros_message->l_lane_id;
  }

  // Field name: l_change_avbl
  {
    cdr << (ros_message->l_change_avbl ? true : false);
  }

  // Field name: r_lane_id
  {
    cdr << ros_message->r_lane_id;
  }

  // Field name: r_change_avbl
  {
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: child_id
  {
    ...
    if (ros_message->child_id.data) {
      rosidl_runtime_c__int32__Sequence__fini(&ros_message->child_id);
    }
    if (!rosidl_runtime_c__int32__Sequence__init(&ros_message->child_id, size)) {
      fprintf(stderr, "failed to create array for field 'child_id'");
      return false;
    }
    auto array_ptr = ros_message->child_id.data;
  ...
  // Field name: father_id
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->father_id.data) {
      rosidl_runtime_c__int32__Sequence__fini(&ros_message->father_id);
    }
    if (!rosidl_runtime_c__int32__Sequence__init(&ros_message->father_id, size)) {
      fprintf(stderr, "failed to create array for field 'father_id'");
      return false;
    }
    auto array_ptr = ros_message->father_id.data;
    cdr.deserializeArray(array_ptr, size);
...
static uint32_t _Lane__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vehicle_msgs__msg__Lane(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vehicle_msgs__msg__Lane;
    is_plain =
      (
...
static size_t _Lane__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vehicle_msgs__msg__Lane(
