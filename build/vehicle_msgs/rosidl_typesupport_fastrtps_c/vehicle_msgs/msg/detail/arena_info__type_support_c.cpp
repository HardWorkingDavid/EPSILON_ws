...
#include "vehicle_msgs/msg/detail/arena_info__rosidl_typesupport_fastrtps_c.h"
...
using _ArenaInfo__ros_msg_type = vehicle_msgs__msg__ArenaInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ArenaInfo__ros_msg_type * ros_message = static_cast<const _ArenaInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ArenaInfo__ros_msg_type * ros_message = static_cast<_ArenaInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_vehicle_msgs__msg__ArenaInfo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ArenaInfo__ros_msg_type * ros_message = static_cast<const _ArenaInfo__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ArenaInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vehicle_msgs__msg__ArenaInfo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vehicle_msgs
size_t max_serialized_size_vehicle_msgs__msg__ArenaInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vehicle_msgs__msg__ArenaInfo;
    is_plain =
      (
...
static size_t _ArenaInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vehicle_msgs__msg__ArenaInfo(
...
static message_type_support_callbacks_t __callbacks_ArenaInfo = {
  "vehicle_msgs::msg",
  "ArenaInfo",
...
static rosidl_message_type_support_t _ArenaInfo__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ArenaInfo,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vehicle_msgs, msg, ArenaInfo)() {
  return &_ArenaInfo__type_support;
}
