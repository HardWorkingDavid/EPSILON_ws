...
#include "vehicle_msgs/msg/detail/state__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point__functions.h"  // vec_position
...
using _State__ros_msg_type = vehicle_msgs__msg__State;
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_geometry_msgs__msg__Point(
    &(ros_message->vec_position), current_alignment);
  // field.name angle
  {
...
static uint32_t _State__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vehicle_msgs__msg__State(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vehicle_msgs__msg__State;
    is_plain =
      (
...
static size_t _State__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vehicle_msgs__msg__State(
