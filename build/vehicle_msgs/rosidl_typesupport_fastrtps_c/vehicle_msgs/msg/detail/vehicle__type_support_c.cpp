...
#include "vehicle_msgs/msg/detail/vehicle__rosidl_typesupport_fastrtps_c.h"
...
#include "std_msgs/msg/detail/string__functions.h"  // subclass, type
#include "vehicle_msgs/msg/detail/state__functions.h"  // state
#include "vehicle_msgs/msg/detail/vehicle_param__functions.h"  // param
...
using _Vehicle__ros_msg_type = vehicle_msgs__msg__Vehicle;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: param
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, vehicle_msgs, msg, VehicleParam
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->param, cdr))
    {
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_vehicle_msgs__msg__VehicleParam(
...
static uint32_t _Vehicle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vehicle_msgs__msg__Vehicle(
  ...
  size_t current_alignment)
{
  ...
  // member: param
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_vehicle_msgs__msg__VehicleParam(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = vehicle_msgs__msg__Vehicle;
    is_plain =
      (
...
static size_t _Vehicle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vehicle_msgs__msg__Vehicle(
