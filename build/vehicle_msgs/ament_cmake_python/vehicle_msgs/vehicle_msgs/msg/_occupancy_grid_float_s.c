...
bool vehicle_msgs__msg__occupancy_grid_float__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vehicle_msgs.msg._occupancy_grid_float.OccupancyGridFloat", full_classname_dest, 57) == 0);
  }
  vehicle_msgs__msg__OccupancyGridFloat * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of OccupancyGridFloat */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vehicle_msgs.msg._occupancy_grid_float");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OccupancyGridFloat");
