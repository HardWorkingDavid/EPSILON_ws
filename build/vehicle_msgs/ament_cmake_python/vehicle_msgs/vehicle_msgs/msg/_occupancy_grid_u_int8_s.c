...
bool vehicle_msgs__msg__occupancy_grid_u_int8__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vehicle_msgs.msg._occupancy_grid_u_int8.OccupancyGridUInt8", full_classname_dest, 58) == 0);
  }
  vehicle_msgs__msg__OccupancyGridUInt8 * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of OccupancyGridUInt8 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vehicle_msgs.msg._occupancy_grid_u_int8");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OccupancyGridUInt8");
