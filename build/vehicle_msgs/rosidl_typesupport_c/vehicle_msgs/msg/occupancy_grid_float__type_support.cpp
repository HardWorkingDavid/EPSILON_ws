...
static const _OccupancyGridFloat_type_support_symbol_names_t _OccupancyGridFloat_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vehicle_msgs, msg, OccupancyGridFloat)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vehicle_msgs, msg, OccupancyGridFloat)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vehicle_msgs, msg, OccupancyGridFloat)() {
  return &::vehicle_msgs::msg::rosidl_typesupport_c::OccupancyGridFloat_message_type_support_handle;
}
