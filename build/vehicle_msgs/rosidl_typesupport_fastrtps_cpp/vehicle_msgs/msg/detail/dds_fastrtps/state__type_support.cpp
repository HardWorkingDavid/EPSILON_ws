...
#include "vehicle_msgs/msg/detail/state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vehicle_msgs::msg::State & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vehicle_msgs::msg::State & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vehicle_msgs::msg::State;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vehicle_msgs::msg::State *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vehicle_msgs::msg::State *>(
    untyped_ros_message);
...
{
  return &vehicle_msgs::msg::typesupport_fastrtps_cpp::_State__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vehicle_msgs, msg, State)() {
  return &vehicle_msgs::msg::typesupport_fastrtps_cpp::_State__handle;
}
