...
#include "vehicle_msgs/msg/detail/vehicle_param__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vehicle_msgs::msg::VehicleParam & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vehicle_msgs::msg::VehicleParam & ros_message)
{
  // Member: width
  cdr >> ros_message.width;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vehicle_msgs::msg::VehicleParam;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vehicle_msgs::msg::VehicleParam *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vehicle_msgs::msg::VehicleParam *>(
    untyped_ros_message);
...
{
  return &vehicle_msgs::msg::typesupport_fastrtps_cpp::_VehicleParam__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vehicle_msgs, msg, VehicleParam)() {
  return &vehicle_msgs::msg::typesupport_fastrtps_cpp::_VehicleParam__handle;
}
