...
#include "vehicle_msgs/msg/detail/control_signal__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vehicle_msgs::msg::ControlSignal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vehicle_msgs::msg::ControlSignal & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vehicle_msgs::msg::ControlSignal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vehicle_msgs::msg::ControlSignal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vehicle_msgs::msg::ControlSignal *>(
    untyped_ros_message);
...
get_message_type_support_handle<vehicle_msgs::msg::ControlSignal>()
{
  return &vehicle_msgs::msg::typesupport_fastrtps_cpp::_ControlSignal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vehicle_msgs, msg, ControlSignal)() {
  return &vehicle_msgs::msg::typesupport_fastrtps_cpp::_ControlSignal__handle;
}
