...
#include "vehicle_msgs/msg/detail/circle_obstacle__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const vehicle_msgs::msg::Circle &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  vehicle_msgs::msg::Circle &);
size_t get_serialized_size(
  const vehicle_msgs::msg::Circle &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const vehicle_msgs::msg::CircleObstacle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vehicle_msgs::msg::CircleObstacle & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: circle
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vehicle_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Circle(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = vehicle_msgs::msg::CircleObstacle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vehicle_msgs::msg::CircleObstacle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vehicle_msgs::msg::CircleObstacle *>(
    untyped_ros_message);
...
{
  return &vehicle_msgs::msg::typesupport_fastrtps_cpp::_CircleObstacle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vehicle_msgs, msg, CircleObstacle)() {
  return &vehicle_msgs::msg::typesupport_fastrtps_cpp::_CircleObstacle__handle;
}
