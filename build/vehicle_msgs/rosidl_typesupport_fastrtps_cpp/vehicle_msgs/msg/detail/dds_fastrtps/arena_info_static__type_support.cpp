...
#include "vehicle_msgs/msg/detail/arena_info_static__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vehicle_msgs::msg::ArenaInfoStatic & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vehicle_msgs::msg::ArenaInfoStatic & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_vehicle_msgs
max_serialized_size_ArenaInfoStatic(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vehicle_msgs::msg::ArenaInfoStatic;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vehicle_msgs::msg::ArenaInfoStatic *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vehicle_msgs::msg::ArenaInfoStatic *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ArenaInfoStatic__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const vehicle_msgs::msg::ArenaInfoStatic *>(
...
static size_t _ArenaInfoStatic__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ArenaInfoStatic(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ArenaInfoStatic__callbacks = {
  "vehicle_msgs::msg",
  "ArenaInfoStatic",
...
static rosidl_message_type_support_t _ArenaInfoStatic__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ArenaInfoStatic__callbacks,
...
{
  return &vehicle_msgs::msg::typesupport_fastrtps_cpp::_ArenaInfoStatic__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vehicle_msgs, msg, ArenaInfoStatic)() {
  return &vehicle_msgs::msg::typesupport_fastrtps_cpp::_ArenaInfoStatic__handle;
}
