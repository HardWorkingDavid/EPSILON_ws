...
#include "vehicle_msgs/msg/detail/circle__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vehicle_msgs::msg::Circle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vehicle_msgs::msg::Circle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vehicle_msgs::msg::Circle *>(
    untyped_ros_message);
...
{
  return &vehicle_msgs::msg::typesupport_fastrtps_cpp::_Circle__handle;
}
