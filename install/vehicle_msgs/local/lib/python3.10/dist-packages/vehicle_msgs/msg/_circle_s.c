...
bool vehicle_msgs__msg__circle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vehicle_msgs.msg._circle.Circle", full_classname_dest, 31) == 0);
  }
  vehicle_msgs__msg__Circle * ros_message = _ros_message;
  {  // center
...
PyObject * vehicle_msgs__msg__circle__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vehicle_msgs.msg._circle");
