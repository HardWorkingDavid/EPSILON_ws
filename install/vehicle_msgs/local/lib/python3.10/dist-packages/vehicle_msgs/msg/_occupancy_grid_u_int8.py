...
class Metaclass_OccupancyGridUInt8(type):
    """Metaclass of message 'OccupancyGridUInt8'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'vehicle_msgs.msg.OccupancyGridUInt8')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__occupancy_grid_u_int8
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__occupancy_grid_u_int8
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__occupancy_grid_u_int8
            cls._TYPE_SUPPORT = module.type_support_msg__msg__occupancy_grid_u_int8
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__occupancy_grid_u_int8
...
class OccupancyGridUInt8(metaclass=Metaclass_OccupancyGridUInt8):
    """Message class 'OccupancyGridUInt8'."""
