...
bool vehicle_msgs__msg__polygon_obstacle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vehicle_msgs.msg._polygon_obstacle.PolygonObstacle", full_classname_dest, 50) == 0);
  }
  vehicle_msgs__msg__PolygonObstacle * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of PolygonObstacle */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vehicle_msgs.msg._polygon_obstacle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PolygonObstacle");
