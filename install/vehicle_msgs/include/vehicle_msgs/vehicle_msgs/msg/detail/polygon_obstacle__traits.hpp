...
#ifndef VEHICLE_MSGS__MSG__DETAIL__POLYGON_OBSTACLE__TRAITS_HPP_
#define VEHICLE_MSGS__MSG__DETAIL__POLYGON_OBSTACLE__TRAITS_HPP_
...
inline std::string to_yaml(const PolygonObstacle & msg, bool use_flow_style = false)
{
...
inline std::string to_yaml(const vehicle_msgs::msg::PolygonObstacle & msg)
{
  return vehicle_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<vehicle_msgs::msg::PolygonObstacle>()
{
  return "vehicle_msgs::msg::PolygonObstacle";
}

template<>
inline const char * name<vehicle_msgs::msg::PolygonObstacle>()
{
  return "vehicle_msgs/msg/PolygonObstacle";
}

template<>
struct has_fixed_size<vehicle_msgs::msg::PolygonObstacle>
  : std::integral_constant<bool, has_fixed_size<geometry_msgs::msg::Polygon>::value && has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<vehicle_msgs::msg::PolygonObstacle>
  : std::integral_constant<bool, has_bounded_size<geometry_msgs::msg::Polygon>::value && has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<vehicle_msgs::msg::PolygonObstacle>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // VEHICLE_MSGS__MSG__DETAIL__POLYGON_OBSTACLE__TRAITS_HPP_
