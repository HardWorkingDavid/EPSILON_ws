...
vehicle_msgs__msg__PolygonObstacle__init(vehicle_msgs__msg__PolygonObstacle * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    vehicle_msgs__msg__PolygonObstacle__fini(msg);
    return false;
  }
  // id
  // polygon
...
vehicle_msgs__msg__PolygonObstacle__create()
{
  ...
  vehicle_msgs__msg__PolygonObstacle * msg = (vehicle_msgs__msg__PolygonObstacle *)allocator.allocate(sizeof(vehicle_msgs__msg__PolygonObstacle), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(vehicle_msgs__msg__PolygonObstacle));
  bool success = vehicle_msgs__msg__PolygonObstacle__init(msg);
  if (!success) {
...
vehicle_msgs__msg__PolygonObstacle__Sequence__init(vehicle_msgs__msg__PolygonObstacle__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vehicle_msgs__msg__PolygonObstacle * data = NULL;

  if (size) {
    data = (vehicle_msgs__msg__PolygonObstacle *)allocator.zero_allocate(size, sizeof(vehicle_msgs__msg__PolygonObstacle), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = vehicle_msgs__msg__PolygonObstacle__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        vehicle_msgs__msg__PolygonObstacle__fini(&data[i - 1]);
      }
...
vehicle_msgs__msg__PolygonObstacle__Sequence__fini(vehicle_msgs__msg__PolygonObstacle__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      vehicle_msgs__msg__PolygonObstacle__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vehicle_msgs__msg__PolygonObstacle__Sequence * array = (vehicle_msgs__msg__PolygonObstacle__Sequence *)allocator.allocate(sizeof(vehicle_msgs__msg__PolygonObstacle__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = vehicle_msgs__msg__PolygonObstacle__Sequence__init(array, size);
  if (!success) {
...
vehicle_msgs__msg__PolygonObstacle__Sequence__destroy(vehicle_msgs__msg__PolygonObstacle__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    vehicle_msgs__msg__PolygonObstacle__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
vehicle_msgs__msg__PolygonObstacle__Sequence__are_equal(const vehicle_msgs__msg__PolygonObstacle__Sequence * lhs, const vehicle_msgs__msg__PolygonObstacle__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!vehicle_msgs__msg__PolygonObstacle__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  vehicle_msgs__msg__PolygonObstacle__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(vehicle_msgs__msg__PolygonObstacle);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    vehicle_msgs__msg__PolygonObstacle * data =
      (vehicle_msgs__msg__PolygonObstacle *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vehicle_msgs__msg__PolygonObstacle__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vehicle_msgs__msg__PolygonObstacle__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!vehicle_msgs__msg__PolygonObstacle__copy(
