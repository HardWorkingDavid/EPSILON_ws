...
vehicle_msgs__msg__VehicleSet__init(vehicle_msgs__msg__VehicleSet * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    vehicle_msgs__msg__VehicleSet__fini(msg);
    return false;
  }
  // vehicles
  if (!vehicle_msgs__msg__Vehicle__Sequence__init(&msg->vehicles, 0)) {
    vehicle_msgs__msg__VehicleSet__fini(msg);
    return false;
  }
  return true;
...
vehicle_msgs__msg__VehicleSet__fini(vehicle_msgs__msg__VehicleSet * msg)
{
  ...
  // vehicles
  vehicle_msgs__msg__Vehicle__Sequence__fini(&msg->vehicles);
}
...
vehicle_msgs__msg__VehicleSet__are_equal(const vehicle_msgs__msg__VehicleSet * lhs, const vehicle_msgs__msg__VehicleSet * rhs)
{
  ...
  // vehicles
  if (!vehicle_msgs__msg__Vehicle__Sequence__are_equal(
  ...
  vehicle_msgs__msg__VehicleSet * output)
{
  ...
  // vehicles
  if (!vehicle_msgs__msg__Vehicle__Sequence__copy(
...
vehicle_msgs__msg__VehicleSet__create()
{
  ...
  vehicle_msgs__msg__VehicleSet * msg = (vehicle_msgs__msg__VehicleSet *)allocator.allocate(sizeof(vehicle_msgs__msg__VehicleSet), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(vehicle_msgs__msg__VehicleSet));
  bool success = vehicle_msgs__msg__VehicleSet__init(msg);
  if (!success) {
...
vehicle_msgs__msg__VehicleSet__Sequence__init(vehicle_msgs__msg__VehicleSet__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vehicle_msgs__msg__VehicleSet * data = NULL;

  if (size) {
    data = (vehicle_msgs__msg__VehicleSet *)allocator.zero_allocate(size, sizeof(vehicle_msgs__msg__VehicleSet), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = vehicle_msgs__msg__VehicleSet__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        vehicle_msgs__msg__VehicleSet__fini(&data[i - 1]);
      }
...
vehicle_msgs__msg__VehicleSet__Sequence__fini(vehicle_msgs__msg__VehicleSet__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      vehicle_msgs__msg__VehicleSet__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vehicle_msgs__msg__VehicleSet__Sequence * array = (vehicle_msgs__msg__VehicleSet__Sequence *)allocator.allocate(sizeof(vehicle_msgs__msg__VehicleSet__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = vehicle_msgs__msg__VehicleSet__Sequence__init(array, size);
  if (!success) {
...
vehicle_msgs__msg__VehicleSet__Sequence__destroy(vehicle_msgs__msg__VehicleSet__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    vehicle_msgs__msg__VehicleSet__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
vehicle_msgs__msg__VehicleSet__Sequence__are_equal(const vehicle_msgs__msg__VehicleSet__Sequence * lhs, const vehicle_msgs__msg__VehicleSet__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!vehicle_msgs__msg__VehicleSet__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  vehicle_msgs__msg__VehicleSet__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(vehicle_msgs__msg__VehicleSet);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    vehicle_msgs__msg__VehicleSet * data =
      (vehicle_msgs__msg__VehicleSet *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vehicle_msgs__msg__VehicleSet__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vehicle_msgs__msg__VehicleSet__fini(&output->data[i]);
        }
        return false;
      }
    }
